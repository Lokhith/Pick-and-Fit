...
interface BeautyHierarchicalDropdownProps {
  name: string
  subcategories: Subcategory[]
  href: string
}

export default function BeautyHierarchicalDropdown({ name, subcategories, href }: BeautyHierarchicalDropdownProps) {
  // Beauty has 6 categories, so we'll use a 3-column layout
  const columnCount = 3
  ...
  return (
    <div className="group relative">
      ...
      {/* Beauty Hierarchical Dropdown Menu - only visible on hover */}
