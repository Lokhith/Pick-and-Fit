          ...
          <div className="relative aspect-[21/9] md:aspect-[3/1] w-full overflow-hidden rounded-xl">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
              <div className="max-w-3xl mx-auto">
                ...
                {/* Enhanced subheading - Same as men's page but with "Beauty" instead of "Men's" */}
                <p className="text-xl md:text-2xl font-medium text-white mb-4 drop-shadow-lg">
                  Exclusive Beauty Collection at <span className="text-yellow-400 font-bold">UNBEATABLE PRICES</span>
                </p>
        ...
        <div className="relative py-8 mb-8 text-center">
          ...
          <div className="mt-4 max-w-2xl mx-auto">
            <p className="text-lg text-muted-foreground">
              Explore our curated collection of premium beauty products for every need
            </p>
          </div>
