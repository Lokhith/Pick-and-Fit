...
import { getProductById, getRelatedProducts, beautyProducts } from "@/lib/product-data"
  ...
  if (!product || product.id === "not-found") {
    ...
    if (beautyProduct) {
      ...
      return {
        ...
        description: "This premium beauty product is designed to enhance your skincare routine.",
